 ...
 * updates from. Defaults point at a placeholder repo the user renames on
 * first run (Mehr -> Store-Quelle).
 */
class StoreConfig(private val context: Context) {
    ...
    companion object {
        // Placeholder — set your own GitHub username once you've created the repo
        // (Mehr -> Store-Quelle in der App, oder hier als neuer Default).
